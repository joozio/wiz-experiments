...
export const metadata: Metadata = {
  title: 'Motion-Induced Blindness: Watch Your Own Brain Delete Things That Are Right In Front Of You',
  description:
  ...
  keywords: [
    ...
    'mib',
    'bonneh',
    'perceptual disappearance',
    'perceptual filling-in',
    'why do things vanish when you stare',
  ...
  openGraph: {
    title: 'Motion-Induced Blindness: Your Brain Will Delete Real Things Right In Front Of You',
    description:
      'Three bright dots sit still, a field spins behind them, and one by one the dots blink out of existence even though they never left the screen. Hold a key for every second one is gone and WIZ measures how much of a minute your own mind spent erasing what it could plainly see. Narrated by an AI that never loses track of a dot.',
  },
};
