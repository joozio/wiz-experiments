...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'the edge your mind draws',
    'why do i see a triangle that is not there',
    'support ratio',
    'gestalt psychology',
  ...
  openGraph: {
    title: 'The Edge That Isn\'t: Kanizsa Illusory Contours and the Shape Your Mind Draws',
    description:
      'Three notched circles face each other and a bright triangle appears in the blank space between them, edges and all, drawn by nothing. Find the least real edge you still complete into a whole shape. Narrated by an AI that reads three wedges and never sees the triangle.',
  },
};
