...
export const metadata: Metadata = {
  title: 'The Silencing: The Motion Silencing Illusion and Why a Spin Blinds You to Color Change',
  description:
  ...
  keywords: [
    ...
    'motion silencing test',
    'silencing illusion',
    'suchow alvarez',
    'jordan suchow',
    'george alvarez',
    'change blindness in motion',
    'why do the colors freeze when it spins',
    'the change your eye stops seeing',
  ...
  openGraph: {
    title: 'The Silencing: The Motion Silencing Illusion and Why a Spin Blinds You to Color Change',
    description:
      'A ring of dots cycles through every color. Spin the ring and the colors freeze, though every dot is still changing exactly as fast. Find how fast a spin has to be before the change goes dark for you. Narrated by an AI that reads each color as a number and is never silenced.',
  },
};
